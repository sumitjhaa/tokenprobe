"""
Comprehensive logging infrastructure for jwtcheck.
...
APP_LOG_FILE = LOG_DIR / "jwtcheck.log"
...
def setup_logging(
    ...
    Returns:
        The configured root logger for jwtcheck.
    """
    ...
    root_logger = logging.getLogger("jwtcheck")
...
def get_logger(name: str) -> logging.Logger:
    """Get a child logger under the jwtcheck namespace."""
    return logging.getLogger(f"jwtcheck.{name}")
