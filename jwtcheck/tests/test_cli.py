...
class TestCLIBasic:
    ...
    def test_version(self, runner):
        ...
        assert "jwtcheck" in result.output
...
class TestCLIExitCodes:
    ...
    def test_exit_1_high_finding(self, runner):
        from jwtcheck.tests.fixtures.tokens import MISSING_EXP_TOKEN
        result = runner.invoke(main, [MISSING_EXP_TOKEN])
        assert result.exit_code == 1

    def test_exit_0_medium_only(self, runner):
        from jwtcheck.tests.fixtures.tokens import MISSING_AUD_TOKEN
